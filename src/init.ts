...
export function initConfigAndDirs(target: string, packageRoot: string): string[] {
...
export function copyWorkflowTemplates(target: string, packageRoot: string): string[] {
  return syncWorkflowTemplates(target, packageRoot).written;
}

export function generateCommands(target: string, packageRoot: string): string[] {
  const written: string[] = [];
...
export function mergeSettings(target: string): string {
...
export function installGenericGit(target: string, packageRoot: string): string[] {
...
export function generateAgentsMd(target: string, packageRoot: string): string[] {
